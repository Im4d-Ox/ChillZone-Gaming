...
const telemetry = [
  { label: "Game Library", value: "8 Games", note: "Premium collection" },
  { label: "Active Users", value: "12.5K", note: "Growing community" },
  { label: "Categories", value: "8 Types", note: "All genres covered" },
  { label: "Satisfaction", value: "4.8/5", note: "Player reviews" },
];
    ...
    >
      <div className="mx-auto flex max-w-[1400px] flex-col gap-16 md:grid md:grid-cols-[5fr_4fr] md:gap-20">
        <AnimatedSection className="flex flex-col gap-8">
          <AnimatedItem>
            <EyebrowBadge>CHILLZONE // STORE STATUS</EyebrowBadge>
          </AnimatedItem>
          <AnimatedItem>
          ...
          <AnimatedItem>
            <p className="max-w-[48ch] font-sans text-base leading-relaxed text-zinc-400 md:text-lg">
              A premium gaming experience curated for you. Chillzone brings you the
              best games across all genres, from action-packed adventures to
              strategic masterpieces. Every stat below reflects our commitment to
              excellence.
            </p>
          </AnimatedItem>
          <AnimatedItem>
